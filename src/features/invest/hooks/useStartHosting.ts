    ...
    mutationFn: async ({investId, hostCarInfo}:ClaimAndCreateCarRequest) => {
      ...
      try {
        ...
        const result = await rentalityContracts.investment.claimAndCreatePool(investId, {
          ...
          brand: 'BRAND0',
          model: 'MODEL0',
          yearOfProduction: BigInt(2000),
          pricePerDayInUsdCents:  BigInt(10000),
          securityDepositPerTripInUsdCents:  BigInt(100),
          engineParams: [  BigInt(4),  BigInt(5) ],
          engineType:  BigInt(1),
          milesIncludedPerDay:  BigInt(100),
          ...
          locationInfo: {
            ...
            signature: '0x63d12417fa1475a2b8a37d3c92514c4baa44692c04fa4dd781fad4499de153da05aca883b81998a8303d1a6fcf6ebace9bfeaaa6ad0a79fb25fc5419f805de0b1b'
          },
