...
export default function RntCarMakeSelect ({id, label, className, value, readOnly, onMakeSelect} : RntCarMakeSelectProps) {
  ...
  >
      ...
      {makesList.map((carMakesListElement) => (
        <option key={"car-make-" + carMakesListElement.id} data-id={carMakesListElement.id} value={carMakesListElement.name}>
