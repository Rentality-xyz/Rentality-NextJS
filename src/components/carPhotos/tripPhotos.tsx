...
const TripPhotos = (
  ...
  const totalPhotos:number = useMemo(() => {
    return fileUrls.checkinByHost.length + fileUrls.checkOutByGuest.length + fileUrls.checkInByGuest.length + fileUrls.checkOutByGuest.length;
  ...
  return (
    <div className="rnt-card my-2 flex flex-col overflow-hidden rounded-xl bg-rentality-bg xl:mr-2">
      <div className="flex flex-col p-2">
        ...
        <div className="flex grow flex-row p-2 w-1/2">
