...
export const changeStatusHostFinishingByHostFormSchema = z
  .object({
...
export type ChangeStatusHostFinishingByHostFormValues = z.infer<typeof changeStatusHostFinishingByHostFormSchema>;
