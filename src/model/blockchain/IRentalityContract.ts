...
import {
    ...
    ContractUpdateCarInfoRequest, InvestmentDTO,
} from "./schemas";
...
export interface IRentalityContract {
    ...
    createCarInvestment(car: {
        inProgress: boolean;
        car: ContractCreateCarRequest;
        priceInUsd: bigint;
        creatorPercents: bigint
    }, name_: string, symbol_: string): Promise<ContractTransactionResponse>;

    getAllInvestments(): Promise<CarInvestment[]>;
}
