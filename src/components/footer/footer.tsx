...
export default function Footer() {
  return (
    <footer className="bg-[url('../images/bg8.jpg')] bg-cover bg-no-repeat bg-center bg-scroll relative max-sm:h-[780px] h-[680px] xl:h-[520px]">
      ...
      <div
        id={"footer-content"}
        className="text-white max-w-[1192px] mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:h-full"
      >
        <div id={"footer-info-block"} className="flex flex-col pt-[70px] max-sm:mx-auto sm:w-full h-full">
          ...
          <div>
            <div className="pt-4 sm:pt-9 font-['Montserrat',Arial,sans-serif] text-3xl font-normal">
              info@rentality.xyz
            </div>
          ...
          <form>
            <div>
              <div id={"input-name"} className="pb-5">
                <input
                  type={"text"}
                  className={"pl-5 pr-5 bg-black h-[50px] text-base rounded-lg w-full"}
                  placeholder={"Name"}
                />
              </div>
            ...
            <button
              type={"submit"}
              className="bg-white text-[#7833fb] hover:text-[#0b1019] pt-0 pb-0 pl-4 pr-4 w-[160px] h-[50px] rounded-[10px] text-xl font-['Montserrat',Arial,sans-serif] font-semibold"
            >
              Submit →
            </button>
          </form>
        ...
        <div className="mt-auto font-['Montserrat',Arial,sans-serif] max-sm:hidden">©2023 by Rentality LLC</div>
      </div>
    </footer>
  );
}
