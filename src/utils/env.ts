...
export const env = createEnv({
  server: {
    ...
    API_MOTIONSCLOUD_SECRET: z.string(),
  ...
  client: {
    ...
    NEXT_PUBLIC_MOTIONSCLOUD_BASE_URL: z.string().min(1),
    NEXT_PUBLIC_MOTIONSCLOUD_ACCOUNT_SID: z.string().min(1),
    NEXT_PUBLIC_MOTIONSCLOUD_ACCOUNT_SECRETKEY: z.string().min(1),
  ...
  experimental__runtimeEnv: {
    ...
    NEXT_PUBLIC_MOTIONSCLOUD_BASE_URL: process.env.NEXT_PUBLIC_MOTIONSCLOUD_BASE_URL,
    NEXT_PUBLIC_MOTIONSCLOUD_ACCOUNT_SID: process.env.NEXT_PUBLIC_MOTIONSCLOUD_ACCOUNT_SID,
    NEXT_PUBLIC_MOTIONSCLOUD_ACCOUNT_SECRETKEY: process.env.NEXT_PUBLIC_MOTIONSCLOUD_ACCOUNT_SECRETKEY,
