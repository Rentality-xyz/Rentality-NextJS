...
import RentalityMotionsCloudJSON_ABI from "./test/RentalityMotionsCloud.v0_2_0.abi.json";
import RentalityMotionsCloudServiceJSON_ADDRESSES from "./test/RentalityMotionsCloud.v0_2_0.addresses.json";
