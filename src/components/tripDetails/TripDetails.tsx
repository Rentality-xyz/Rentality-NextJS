			...
			{isLoading ? (
				...
				<>
					...
					<div className="flex overflow-hidden my-6">
						<div class="basis-2/3">
							<div className="rnt-card flex flex-col rounded-xl overflow-hidden bg-rentality-bg m-1">
						...
						<div class="basis-1/3">
							<div class="rnt-card flex flex-col rounded-xl overflow-hidden bg-rentality-bg m-1">
								<div class="flex flex-row grow">
