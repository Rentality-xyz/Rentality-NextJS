            ...
            <div className="flex w-full flex-col justify-between p-2 sm:p-4">
                ...
                <div className="flex md:grid md:grid-cols-[2fr_1fr] text-xs mt-2 md:justify-between">
                    <div className="w-9/12 flex flex-col">
                        <div>
                            <strong>{t_item("price")} ${searchInfo.totalPriceWithDiscount}</strong>
                        </div>
                        <div className="mt-2">
                        ...
                        <div>{t_item("miles_included")} ${searchInfo.milesIncludedPerDay}</div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <div>- {searchInfo.seatsNumber} {t_item("seats")}</div>
                    </div>
                </div>
                <div className="w-full grid grid-cols-[1fr_auto] items-end mt-2">
                    ...
                    >
                        ...
                        <div>{t_item("total")} ${searchInfo.totalPriceWithDiscount + searchInfo.securityDeposit}</div>
                    </RntButton>
                </div>
            </div>
        </div>
