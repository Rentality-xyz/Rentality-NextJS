...
export default function LegalContent() {
    ...
    const classTabsItem = "flex text-sm lg:text-base text-center justify-center items-center font-['Montserrat',Arial,sans-serif] sm:mr-6";
    ...
    const renderContent = () => {
        switch (activeTab) {
            case ELegalMatters.TERMS:
                return <iframe src="/legal_matters/legal_terms.html" className="w-full h-[740px] bg-white mx-auto py-8" />;
            case ELegalMatters.CANCELLATION:
                return <iframe src="/legal_matters/legal_cancellation.html" className="w-full h-[740px] bg-white mx-auto py-8" />;
            case ELegalMatters.PROHIBITEDUSES:
                return <iframe src="/legal_matters/legal_prohibited.html" className="w-full h-[740px] bg-white mx-auto py-8" />;
            case ELegalMatters.PRIVACY:
                return <iframe src="/legal_matters/legal_privacy.html" className="w-full h-[740px] bg-white mx-auto py-8" />;
            default:
                return null;
        }
    };
