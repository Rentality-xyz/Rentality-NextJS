      ...
      {isLoading ? (
        ...
        <>
          <div className="my-4 flex flex-col md:grid grid-cols-2 gap-4 pr-4">
            ...
            <RntInput id="host" label={t_details("host_addr")} value={tripDetails.host} readOnly={true} />
            <RntInput id="guest" label={t_details("guest_addr")} value={tripDetails.guest} readOnly={true} />
            <RntInput
              id="startDateTime"
