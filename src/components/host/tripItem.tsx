    ...
    <div className="rnt-card flex flex-col rounded-xl overflow-hidden bg-rentality-bg">
      <div className="sm_inverted:flex max-2xl:flex-wrap 2xl:flex-nowrap">
        ...
        <div id="host-trip-item-info" className="w-full flex flex-col sm_inverted:flex-row">
          ...
          <div id="host-trip-action-info" className="w-full sm_inverted:w-1/4 flex flex-1 flex-col justify-between gap-2 p-4 md:p-2 xl:p-4">
            <div className="flex flex-col">
          ...
          <div id="host-trip-info" className="w-full sm_inverted:w-1/4 flex flex-1 flex-col gap-2 p-4 md:p-2 xl:p-4 2xl:ml-14">
        ...
        <div id="trip-contact-info" className="max-2xl:w-full 2xl:w-46 flex flex-col 2xl:flex-shrink-0 p-4 md:p-2 xl:p-4 text-end">
