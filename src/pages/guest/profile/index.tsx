...
import useMotionsCloud from "@/features/motionsCloud/hooks/useMotionsCloud";
import RntButton from "@/components/common/rntButton";
import { ChangeEvent, FormEvent, useState } from "react";
import { MotionsCloudPhoto, photoTypes } from "@/model/MotionsCloud";
import { fileToBase64 } from "@/pages/api/motionscloud/uploadPhoto";
...
function Profile() {
  ...
  const [getAiResponseByTripIfExists, handleUploadPhoto, handleCreateCase] = useMotionsCloud()
