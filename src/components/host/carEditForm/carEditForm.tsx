            ...
            <form onSubmit={handleSubmit(async (data) => await onFormSubmit(data))}>
                ...
                <div className="mt-4">
                    ...
                    <div className="w-80 h-60 rounded-2xl mt-8 overflow-hidden bg-gray-200 bg-opacity-40">
                        {!isEmpty(image) ? (
                            <Image className="h-full w-full object-cover" width={1000} height={1000} src={image}
                                   alt=""/>
                        ) : null}
                    </div>
                ...
                <div className="mt-4">
                    ...
                    <div className="flex flex-wrap gap-4">
                        <RntInput
                            ...
                            placeholder="USA"
                            readOnly={true}
                            value={locationInfo? locationInfo.country : ""}
                        />
                        <RntInput
                            className="lg:w-40"
                            id="state"
                            ...
                            placeholder="e.g. Florida"
                            readOnly={true}
                            value={locationInfo? locationInfo.state : ""}
                        />
                        <RntInput
                            className="lg:w-40"
                            id="city"
                            ...
                            readOnly={true}
                            value={locationInfo? locationInfo.city : ""}
                        />
                        <RntInput
                            ...
                            readOnly={true}
                            value={locationInfo? locationInfo.latitude : ""}
                        />
                        <RntInput
                            className="w-[48%] lg:w-60"
                            ...
                            placeholder="e.g. 42.123456"
                            readOnly={true}
                            value={locationInfo? locationInfo.longitude: ""}
                        />
                    </div>
                </div>
...
const MilesIncludedPerDay = ({
    ...
    return (
        <>
            {isUnlimited ? (
                <RntInput className="lg:w-60" label={t_car("max_mileage")} readOnly={true}
