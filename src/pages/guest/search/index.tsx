...
export default function Search() {
    ...
    const handleRentCarRequest = async (carInfo: SearchCarInfo) => {
        const t_er = (name: string) => {
            return t_page("errors." + name)
        }
        try {
    ...
    return (
        <GoogleMapsProvider libraries={['maps', 'marker', 'places']}>
          ...
          /> */}
                    ...
                    {isLoading ? (
                        <div
                            className="mt-5 flex max-w-screen-xl flex-wrap justify-between text-center">Loading...</div>
                    ) : (
                        <>
                            <div
                                className="text-l font-bold">{searchResult?.carInfos?.length ?? 0} {t_page("info.cars_available")}
                            </div>
                            <div className="grid grid-cols-2">
                                <div className="my-4 grid grid-cols-1 gap-4">{
                                    searchResult?.carInfos?.length > 0 ? (
                                        ...
                                        <div
                                            className="mt-5 flex max-w-screen-xl flex-wrap justify-between text-center">
                                            {t_page("info.no_cars")}
                                        </div>
                                    )}
                                </div>
                    ...
                    >
                        <div className="flex flex-col py-8">
                            ...
                            <div className="flex flex-col gap-2 sm:gap-4 px-2 sm:px-4 md:px-8 lg:px-16 mt-4">
                                ...
                                />
                                <div
                                    className="flex flex-col sm:flex-row gap-4 sm:gap-8 max-sm:mt-2 sm:justify-between">
                                    <RntButton
