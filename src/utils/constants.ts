...
export const WETH_ADDRESS = ethers.getAddress("0x4200000000000000000000000000000000000006");
...
export const MIN_ETH_ON_WALLET_FOR_TRANSACTION = 0.0004 * 10 ** 18; // 0.0004 ETH
