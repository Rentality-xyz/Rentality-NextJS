...
export function useGuestInsurances() {
...
export function AddGuestInsurance() {
  ...
  return (
    <div className="flex flex-col gap-2">
      <RntButtonTransparent>{t("insurance.add_insurance")}</RntButtonTransparent>
      <hr />
      <div className="flex">
        <div className="flex flex-col">Insurance type General Insurance ID One-Time trip insurance</div>
...
export function GuestInsuranceFilters({ defaultFilters, onApply }: GuestInsuranceFiltersProps) {
  const { t } = useTranslation();
...
export function GuestInsuranceTable({ isLoading, data }: GuestInsuranceTableProps) {
  const { t } = useTranslation();
