...
function СarDetails({ tripInfo, isHost, t, showMoreInfo }: { tripInfo: TripInfo; isHost: boolean; t: TFunction; showMoreInfo: boolean; }) {
  ...
  return (
    <div id="trip-main-info" className="w-full md:w-1/4 flex flex-1 flex-col gap-4 justify-between p-4 md:p-2 xl:p-4">
      <div className="flex flex-col">
        ...
        {!showMoreInfo ? (<div>{t('vehicles.state')}: {tripInfo.licenseState}</div>) : <></>}
      ...
      <UserAvatarWithName photoUrl={otherUserPhotoUrl} userName={otherUserName} label={isHost ? "YOUR GUEST" : "HOSTED BY"} />
      {!showMoreInfo ? (
