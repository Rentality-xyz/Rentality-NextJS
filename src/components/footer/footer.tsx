    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="z-0 min-[560px]:mt-auto mt-52 font-['Montserrat',Arial,sans-serif]">©{moment().year()} by Rentality LLC</div>
          <div className="z-0 mt-0 text-xs sm:hidden text-center">
            UIcons by <a href="https://www.flaticon.com/uicons">Flaticon</a>
          </div>
        </div>
      </div>
