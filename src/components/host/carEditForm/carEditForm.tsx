...
import { DimoCarResponseWithTimestamp } from "@/pages/host/dimo";
...
export default function CarEditForm({
  ...
  if(dimoItem !== null) {
    ...
    if(parsedData.timestamp && parsedData.timestamp + expirationTime  > timestamp)
      dimoData = parsedData
    else {
